...
@Component({
  selector: 'app-display-alert-unauth',
  standalone: true,
  imports: [CommonModule, NgIf],
  templateUrl: './display-alert-unauth.component.html',
  styleUrls: ['./display-alert-unauth.component.scss'],
})
export class DisplayAlertUnauthComponent {
  @Input() mensagem = '';
